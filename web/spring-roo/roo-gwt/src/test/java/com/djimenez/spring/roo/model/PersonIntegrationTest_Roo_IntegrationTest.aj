...
import com.djimenez.spring.roo.model.PersonDataOnDemand;
...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = com.djimenez.spring.roo.model.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        ...
        com.djimenez.spring.roo.model.Person obj = com.djimenez.spring.roo.model.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<com.djimenez.spring.roo.model.Person> result = com.djimenez.spring.roo.model.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<com.djimenez.spring.roo.model.Person> result = com.djimenez.spring.roo.model.Person.findPersonEntries(0, (int)count);
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        com.djimenez.spring.roo.model.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", com.djimenez.spring.roo.model.Person.findPerson(id));
    }
