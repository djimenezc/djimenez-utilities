package com.djimenez.example.spring.mvc.web.spring;
 ...
 * 
 * <pre>
 * &lt;bean class=&quot;com.gowex.webapp.spring.ValidatorExtensionPostProcessor&quot;&gt;
 ...
 */
public class ValidatorExtensionPostProcessor implements
  ...
  public final void postProcessBeanFactory(
    ...
    if (configurableListableBeanFactory.containsBean(validatorFactoryBeanName)) {
      ...
      final MutablePropertyValues propertyValues =
        validatorFactoryBeanDefinition.getPropertyValues();
