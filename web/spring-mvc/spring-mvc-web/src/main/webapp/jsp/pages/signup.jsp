...
<ul>
    ...
    <li>
        <djimenez:label styleClass="desc" key="user.username"/>
    ...
    <li>
        <div>
            <div class="left">
                <djimenez:label styleClass="desc" key="user.password"/>
            ...
            <div>
                <djimenez:label styleClass="desc" key="user.confirmPassword"/>
    ...
    <li>
        <djimenez:label styleClass="desc" key="user.passwordHint"/>
    ...
    <li>
        <div>
            <div class="left">
                <djimenez:label styleClass="desc" key="user.email"/>
                <form:errors path="email" cssClass="fieldError"/>
                <form:input path="email" id="email" cssClass="text medium" cssErrorClass="text medium error"/>
            </div>
            <div>
                <djimenez:label styleClass="desc" key="user.phoneNumber"/>
    ...
    <li>
        <djimenez:label styleClass="desc" key="user.website"/>
    ...
    <li>
        ...
        <div class="group">
            <div>
                ...
                <p><djimenez:label key="user.address.address"/></p>
            </div>
            <div class="left">
                ...
                <p><djimenez:label key="user.address.city"/></p>
            </div>
            <div>
                ...
                <p><djimenez:label key="user.address.province"/></p>
            </div>
            <div class="left">
                ...
                <p><djimenez:label key="user.address.postalCode"/></p>
            </div>
            <div>
                <djimenez:country name="address.country" prompt="" default="${user.address.country}"/>
                <p><djimenez:label key="user.address.country"/></p>
            </div>
        </div>
    </li>
