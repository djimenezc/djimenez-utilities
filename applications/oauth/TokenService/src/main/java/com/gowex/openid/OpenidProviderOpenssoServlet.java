...
import com.gowex.util.properties.PropertyHelper;

public class OpenidProviderOpenssoServlet extends HttpServlet {
  ...
  public OpenidProviderOpenssoServlet() {

    END_POINT_URL =
      PropertyHelper.getInstance().getProperty("openid.provider",
