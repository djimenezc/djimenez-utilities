...
import com.djimenez.spring.roo.server.domain.EmployeeDataOnDemand;
...
privileged aspect EmployeeIntegrationTest_Roo_IntegrationTest {
    ...
    public void EmployeeIntegrationTest.testCountEmployees() {
        ...
        long count = com.djimenez.spring.roo.server.domain.Employee.countEmployees();
    ...
    public void EmployeeIntegrationTest.testFindEmployee() {
        ...
        com.djimenez.spring.roo.server.domain.Employee obj = com.djimenez.spring.roo.server.domain.Employee.findEmployee(id);
    ...
    public void EmployeeIntegrationTest.testFindAllEmployees() {
        ...
        java.util.List<com.djimenez.spring.roo.server.domain.Employee> result = com.djimenez.spring.roo.server.domain.Employee.findAllEmployees();
    ...
    public void EmployeeIntegrationTest.testFindEmployeeEntries() {
        ...
        java.util.List<com.djimenez.spring.roo.server.domain.Employee> result = com.djimenez.spring.roo.server.domain.Employee.findEmployeeEntries(0, (int)count);
    ...
    public void EmployeeIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Employee' failed to initialize correctly", dod.getRandomEmployee());
        com.djimenez.spring.roo.server.domain.Employee obj = dod.getNewTransientEmployee(Integer.MAX_VALUE);
    ...
    public void EmployeeIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Employee' with identifier '" + id + "'", com.djimenez.spring.roo.server.domain.Employee.findEmployee(id));
    }
