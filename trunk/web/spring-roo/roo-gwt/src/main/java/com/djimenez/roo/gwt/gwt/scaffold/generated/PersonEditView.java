...
/**
 * Edit view for Person records.
 */
public class PersonEditView extends Composite implements
    RecordEditView<PersonRecord> {
  interface Binder extends UiBinder<HTMLPanel, PersonEditView> {
  }

  interface DataBinder extends EditorSupport<PersonRecord, PersonEditView> {
  }
  ...
  public PersonEditView asWidget() {
    return this;
  }
  ...
  public void setValue(PersonRecord value) {
    this.record = value;
